...
const conversation = function (chat) {
    $('#chat-list').append(` <a href="#${chat.id}"
    class="card border-0 text-reset" data-messages="${chat.id}">
    <div class="card-body">
        <div class="row gx-5">
            <div class="col-auto">
            ...
            <div class="col">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <span
                        class="text-muted extra-small ms-2">${moment(chat.last_message.created_at).fromNow()}
                    </span>
                </div>
